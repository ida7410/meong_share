 ...
 */
	...
	var url = "https://data.seoul.go.kr/dataList/dataView.do?onepagerow=1000&srvType=S&infId=OA-16007&serviceKind=1&pageNo=1&gridTotalCnt=2105&ssUserId=SAMPLE_VIEW&strWhere=&strOrderby=&filterCol=TRDSTATEGBN&txtFilter=01"
	$.ajax({
		url:url
	...
	let mydata = JSON.parse(JSON.stringify(VET));
	...
	$("#search-btn").on("click", searchPlaces());
